...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ITECOMMPAY/msdk-react-native.git", :tag => "#{s.version}" }
  ...
  if defined?(:spm_dependency)
    spm_dependency(s,
      ...
      requirement: {kind: 'upToNextMajorVersion', minimumVersion: '4.0.7'},
